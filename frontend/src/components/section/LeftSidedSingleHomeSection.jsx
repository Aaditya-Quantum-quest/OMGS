...
export default function LeftSidedSingleHomeSections(props) {
  ...
  return (
    <section className="w-full bg-zinc-900 lg:py-12 px-4 sm:px-6 lg:px-8 lg:pt-30 pt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left px-4 lg:px-8">
            ...
            <div className='flex justify-center '>
              <button className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold text-lg hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105" onClick={() => handleIndividualNavigate(props.path)}>
                Shop now
              </button>
            </div>
          </div>
