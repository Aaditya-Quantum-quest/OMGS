...
//     console.log('Product data before upload:', productData); // Debug
...
//       console.log('Uploading images...'); // Debug
...
//       console.log('Upload response:', uploadRes.data); // Debug
...
//     console.log('Final product data:', productData); // Debug
...
//   } catch (err) {
//     console.error('Error saving product:', err); // Debug
...
//               >
//                 <option value="" className='bg-black'>Select a category</option> {/* Add this line */}
//                 <option value="Acrylic Photo" className='bg-black'>Acrylic Photo</option>
//                 <option value="Framed Acrylic Photo" className='bg-black'>Framed Acrylic Photo</option>
//                 <option value="Acrylic Cutout" className='bg-black'>Acrylic Cutout</option>
