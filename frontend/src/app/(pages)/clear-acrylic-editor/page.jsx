        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="bg-white rounded-md shadow-md p-6 relative">
              ...
              <div
                style={{
                  background: 'linear-linear(45deg, #e5e7eb 25%, transparent 25%, transparent 75%, #e5e7eb 75%, #e5e7eb), linear-linear(45deg, #e5e7eb 25%, transparent 25%, transparent 75%, #e5e7eb 75%, #e5e7eb)',
          ...
          <div className="lg:w-80 bg-white rounded-md shadow-md p-6 space-y-6">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {FRAME_COLORS.map((c) => (
                      <button
                        ...
                        className={`w-9 h-9 rounded border-2 transition-all ${frameColor === c.color ? "border-blue-500 scale-110" : "border-gray-300"
                          }`}
            ...
            <div className="space-y-3 pt-3 border-t">
              <button
                ...
                className={`w-full font-semibold py-3 px-4 rounded-md text-base transition-colors flex items-center justify-center gap-2 ${bgRemovedImg && !isProcessing
              ...
              <button
                ...
                disabled={!bgRemovedImg || isProcessing}
                className={`w-full font-semibold py-3 px-4 rounded-md text-lg transition-colors ${bgRemovedImg && !isProcessing
